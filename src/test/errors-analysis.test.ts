...
test('wireit section is not an object', async () => {
...
test('wireit config is not an object', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('dependencies is not an array', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('dependency is not a string', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test(`dependencies.script is not a string (object form)`, async () => {
  await using rig = await WireitTestRig.setup();
...
test('dependency is empty or blank', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test(`dependencies.script is empty or blank (object form)`, async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write('package.json', {
    scripts: {
      a: 'wireit',
...
test(`dependencies.script is missing (object form)`, async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write('package.json', {
    scripts: {
      a: 'wireit',
...
test('command is empty or blank', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('files is not an array', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('file item is not a string', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('file item is empty or blank', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('output is not an array', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('output item is not a string', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('output item is empty or blank', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('clean is not a boolean or "if-file-deleted"', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('allowUsuallyExcludedPaths is not a boolean', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('packageLocks is not an array', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('packageLocks item is not a string', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('packageLocks item is empty or blank', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('packageLocks item is not a filename', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('missing cross package dependency', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('missing cross package dependency (object form)', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('missing same-package dependency with colon in name', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('missing cross package dependency with complicated escaped names', async () => {
  await using rig = await WireitTestRig.setup();
...
test('cross-package dependency with complicated escaped name leads to directory without package.json', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'foo/package.json': {
      scripts: {
...
test('duplicate dependency', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('script command is not wireit', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('script is wireit but has no wireit config', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('script has no command, dependencies, or files', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('script has no command and empty dependencies and files', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test("cross-package dependency doesn't have a colon", async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test("cross-package dependency doesn't have a script name", async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('cross-package dependency resolves to the same package (".")', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('cross-package dependency resolves to the same package (up and back)', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'foo/package.json': {
      scripts: {
...
test('cross-package dependency leads to directory without package.json', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'foo/package.json': {
      scripts: {
...
test('cross-package dependency leads to package.json with invalid JSON', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'foo/package.json': {
      scripts: {
...
test('2 cycles of length 1', async () => {
  await using rig = await WireitTestRig.setup();
  //  a -----> b
  //  ^ \     ^ \
  //  | |     | |
...
test('cycle with lead up and lead out', async () => {
  await using rig = await WireitTestRig.setup();
  //  a --> b --> c --> d --> e
  //        ^           |
  //        |           |
...
test('cycle with multiple trails', async () => {
  await using rig = await WireitTestRig.setup();
  //    +------+
  //   /        \
  //  /          v
...
test('cycle with multiple trails (with different dependency order)', async () => {
  await using rig = await WireitTestRig.setup();
  //    +------+
  //   /        \
  //  /          v
...
test('cycle across packages', async () => {
  await using rig = await WireitTestRig.setup();
  //  foo:a --> bar:b
  //    ^         |
  //    |         |
...
test('script without command cannot have output', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('service is not a boolean or object', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('service does not have command', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('service cannot have output', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('dependencies.cascade is not a boolean', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('service.readyWhen must be an object', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('service.readyWhen.lineMatches must be a string', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('service.readyWhen.lineMatches must be a valid regular expression', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('env must be an object', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('env entry value must be a string or object', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('env entry value that is object must have an "external" property', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('env entry value that is object must have "external" set to true', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test('env entry value that is object with "default" property must be a string', async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
...
test("script with no command can't have env", async () => {
  await using rig = await WireitTestRig.setup();
  await rig.write({
    'package.json': {
      scripts: {
