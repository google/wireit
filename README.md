...
To change this behavior and further optimize your build, you can use the `soft`
setting to tell Wireit that all of the input files needed from a dependency are
declared in the `files` array. Now, Wireit won't assume that a script was stale
just because its dependency ran.
